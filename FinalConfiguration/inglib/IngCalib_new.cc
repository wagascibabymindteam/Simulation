...
float       gain[17][2][22][32];
float        ped[17][2][22][32];
float     logain[17][2][22][32];
float      loped[17][2][22][32];
...
float HighGain[17][2][22][32];
float HighPed [17][2][22][32];
int   LowPed  [17][2][22][32];
bool  GoodCh  [17][2][22][32];
