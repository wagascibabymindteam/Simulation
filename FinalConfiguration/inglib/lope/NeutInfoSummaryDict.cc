//
// File generated by rootcint at Fri Aug 12 05:13:44 2011
...
/* NeutInfoSummary */
static int G__NeutInfoSummaryDict_146_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_NeutInfoSummary));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__NeutInfoSummaryDict_146_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   NeutInfoSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__NeutInfoSummaryDict_146_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) NeutInfoSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__NeutInfoSummaryDict_146_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) NeutInfoSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__NeutInfoSummaryDict_146_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) NeutInfoSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__NeutInfoSummaryDict_146_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__NeutInfoSummaryDict_146_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__NeutInfoSummaryDict_146_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) NeutInfoSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__NeutInfoSummaryDict_146_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) NeutInfoSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__NeutInfoSummaryDict_146_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) NeutInfoSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__NeutInfoSummaryDict_146_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__NeutInfoSummaryDict_146_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__NeutInfoSummaryDict_146_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableNeutInfoSummaryDict() {
   ...
   G__search_typename2("vector<TSchemaHelper>",117,G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_reverse_iteratorlEvectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_reverse_iteratorlEvectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<ROOT::TSchemaHelper>",117,G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
}
...
static void G__setup_memfuncNeutInfoSummary(void) {
   ...
   G__memfunc_setup("NeutInfoSummary",1558,G__NeutInfoSummaryDict_146_0_1, 105, G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_NeutInfoSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NeutInfoSummary",1558,G__NeutInfoSummaryDict_146_0_2, 105, G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_NeutInfoSummary), -1, 0, 1, 1, 1, 0, "u 'NeutInfoSummary' - 11 - neut", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("Class",502,G__NeutInfoSummaryDict_146_0_5, 85, G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (TClass* (*)())(&NeutInfoSummary::Class), 0);
   G__memfunc_setup("Class_Name",982,G__NeutInfoSummaryDict_146_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&NeutInfoSummary::Class_Name), 0);
   G__memfunc_setup("Class_Version",1339,G__NeutInfoSummaryDict_146_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (Version_t (*)())(&NeutInfoSummary::Class_Version), 0);
   G__memfunc_setup("Dictionary",1046,G__NeutInfoSummaryDict_146_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (void (*)())(&NeutInfoSummary::Dictionary), 0);
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent", (char*)NULL, (void*) NULL, 1);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__NeutInfoSummaryDict_146_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__NeutInfoSummaryDict_146_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&NeutInfoSummary::DeclFileName), 0);
   G__memfunc_setup("ImplFileLine",1178,G__NeutInfoSummaryDict_146_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (int (*)())(&NeutInfoSummary::ImplFileLine), 0);
   G__memfunc_setup("ImplFileName",1171,G__NeutInfoSummaryDict_146_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&NeutInfoSummary::ImplFileName), 0);
   G__memfunc_setup("DeclFileLine",1152,G__NeutInfoSummaryDict_146_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (int (*)())(&NeutInfoSummary::DeclFileLine), 0);
   // automatic destructor
   G__memfunc_setup("~NeutInfoSummary", 1684, G__NeutInfoSummaryDict_146_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__NeutInfoSummaryDict_146_0_18, (int) ('u'), G__get_linked_tagnum(&G__NeutInfoSummaryDictLN_NeutInfoSummary), -1, 1, 1, 1, 1, 0, "u 'NeutInfoSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__NeutInfoSummaryDictLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR = { "vector<ROOT::TSchemaHelper,allocator<ROOT::TSchemaHelper> >" , 99 , -1 };
G__linked_taginfo G__NeutInfoSummaryDictLN_reverse_iteratorlEvectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgRcLcLiteratorgR = { "reverse_iterator<vector<ROOT::TSchemaHelper,allocator<ROOT::TSchemaHelper> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableNeutInfoSummaryDict() {
  ...
  G__NeutInfoSummaryDictLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR.tagnum = -1 ;
  G__NeutInfoSummaryDictLN_reverse_iteratorlEvectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableNeutInfoSummaryDict() {
   ...
   G__get_linked_tagnum_fwd(&G__NeutInfoSummaryDictLN_vectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgR);
   G__get_linked_tagnum_fwd(&G__NeutInfoSummaryDictLN_reverse_iteratorlEvectorlEROOTcLcLTSchemaHelpercOallocatorlEROOTcLcLTSchemaHelpergRsPgRcLcLiteratorgR);
