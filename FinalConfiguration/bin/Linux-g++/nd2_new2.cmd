...
Arguments = -o /export/scraid1/data/kikawa/mc_t2kreweight_pm_new2/pmmc_$(Process).root -i /export/scbn07/data2/kikawa/neutfile_run1/11bfluka_nd2_numu_ch_$(Process).nt -m 2 -f 1
