...
Arguments = -o /export/scraid1/data/kikawa/mc_t2kreweight_new/ingmc_nd3_run1_$(Process).root -i /export/scbn07/data2/kikawa/neutfile_run1/11bfluka_nd3_numu_fe_$(Process).nt -m 3 -f 1
