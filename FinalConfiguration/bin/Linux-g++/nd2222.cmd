...
#side Fe BG
Arguments = -o /export/scbn07/data2/taichiro/mc_water_muid37/B2mc_h2o_$(Process).root -i /export/scraid2/data/minamino/neut/11b_b2water/11b_b2water_fe/11b_nd7_numu_fe_$(Process).nt -m 6 -f 1

#downstream Fe BG
#Arguments = -o /export/scbn07/data2/taichiro/mc_water_muid33/B2mc_h2o_$(Process).root -i /export/scraid2/data/minamino/neut/11b_b2water/11b_b2water_fe/11b_nd7_numu_fe_$(Process).nt -m 7 -f 1
