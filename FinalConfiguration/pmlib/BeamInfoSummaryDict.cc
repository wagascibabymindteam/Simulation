//
// File generated by rootcint at Wed May 20 18:42:38 2015
...
/* BeamInfoSummary */
static int G__BeamInfoSummaryDict_168_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   result7->ref = (long) p;
   result7->type = 'u';
   result7->tagnum = G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   BeamInfoSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__BeamInfoSummaryDict_168_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((BeamInfoSummary*) G__getstructoffset())->Print();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) BeamInfoSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) BeamInfoSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_168_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_168_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) BeamInfoSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_168_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_168_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BeamInfoSummaryDict_168_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncBeamInfoSummary(void) {
   ...
   G__memfunc_setup("BeamInfoSummary",1519,G__BeamInfoSummaryDict_168_0_1, 105, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BeamInfoSummary",1519,G__BeamInfoSummaryDict_168_0_2, 105, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 0, 1, 1, 1, 0, "u 'BeamInfoSummary' - 11 - info", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__BeamInfoSummaryDict_168_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__BeamInfoSummaryDict_168_0_5, 85, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (TClass* (*)())(&BeamInfoSummary::Class), 0);
   G__memfunc_setup("Class_Name",982,G__BeamInfoSummaryDict_168_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&BeamInfoSummary::Class_Name), 0);
   G__memfunc_setup("Class_Version",1339,G__BeamInfoSummaryDict_168_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (Version_t (*)())(&BeamInfoSummary::Class_Version), 0);
   G__memfunc_setup("Dictionary",1046,G__BeamInfoSummaryDict_168_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (void (*)())(&BeamInfoSummary::Dictionary), 0);
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent", (char*)NULL, (void*) NULL, 1);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__BeamInfoSummaryDict_168_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__BeamInfoSummaryDict_168_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&BeamInfoSummary::DeclFileName), 0);
   G__memfunc_setup("ImplFileLine",1178,G__BeamInfoSummaryDict_168_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (int (*)())(&BeamInfoSummary::ImplFileLine), 0);
   G__memfunc_setup("ImplFileName",1171,G__BeamInfoSummaryDict_168_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&BeamInfoSummary::ImplFileName), 0);
   G__memfunc_setup("DeclFileLine",1152,G__BeamInfoSummaryDict_168_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (int (*)())(&BeamInfoSummary::DeclFileLine), 0);
   // automatic destructor
   G__memfunc_setup("~BeamInfoSummary", 1645, G__BeamInfoSummaryDict_168_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BeamInfoSummaryDict_168_0_18, (int) ('u'), G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 1, 1, 1, 1, 0, "u 'BeamInfoSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
