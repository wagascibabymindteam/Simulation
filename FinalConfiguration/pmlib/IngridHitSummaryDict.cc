//
// File generated by rootcint at Wed May 20 18:42:34 2015
...
/* IngridHitSummary */
static int G__IngridHitSummaryDict_121_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   result7->ref = (long) p;
   result7->type = 'u';
   result7->tagnum = G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   IngridHitSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__IngridHitSummaryDict_121_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_121_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 102, (double) ((IngridHitSummary*) G__getstructoffset())->Pe());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridHitSummary*) G__getstructoffset())->NSimHits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_121_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridHitSummary*) G__getstructoffset())->GetIngridSimHit((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) IngridHitSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) IngridHitSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_121_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_121_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) IngridHitSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_121_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_121_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__IngridHitSummaryDict_121_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncIngridHitSummary(void) {
   ...
   G__memfunc_setup("IngridHitSummary",1648,G__IngridHitSummaryDict_121_0_1, 105, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IngridHitSummary",1648,G__IngridHitSummaryDict_121_0_2, 105, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 0, 1, 1, 1, 0, "u 'IngridHitSummary' - 11 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__IngridHitSummaryDict_121_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Pe",181,G__IngridHitSummaryDict_121_0_5, 102, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NSimHits",783,G__IngridHitSummaryDict_121_0_6, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddIngridSimHit",1460,G__IngridHitSummaryDict_121_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridSimHitSummary' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIngridSimHit",1483,G__IngridHitSummaryDict_121_0_8, 85, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridSimHitSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__IngridHitSummaryDict_121_0_9, 85, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (TClass* (*)())(&IngridHitSummary::Class), 0);
   G__memfunc_setup("Class_Name",982,G__IngridHitSummaryDict_121_0_10, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&IngridHitSummary::Class_Name), 0);
   G__memfunc_setup("Class_Version",1339,G__IngridHitSummaryDict_121_0_11, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (Version_t (*)())(&IngridHitSummary::Class_Version), 0);
   G__memfunc_setup("Dictionary",1046,G__IngridHitSummaryDict_121_0_12, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (void (*)())(&IngridHitSummary::Dictionary), 0);
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent", (char*)NULL, (void*) NULL, 1);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__IngridHitSummaryDict_121_0_16, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__IngridHitSummaryDict_121_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&IngridHitSummary::DeclFileName), 0);
   G__memfunc_setup("ImplFileLine",1178,G__IngridHitSummaryDict_121_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (int (*)())(&IngridHitSummary::ImplFileLine), 0);
   G__memfunc_setup("ImplFileName",1171,G__IngridHitSummaryDict_121_0_19, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) (const char* (*)())(&IngridHitSummary::ImplFileName), 0);
   G__memfunc_setup("DeclFileLine",1152,G__IngridHitSummaryDict_121_0_20, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) (int (*)())(&IngridHitSummary::DeclFileLine), 0);
   // automatic destructor
   G__memfunc_setup("~IngridHitSummary", 1774, G__IngridHitSummaryDict_121_0_21, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__IngridHitSummaryDict_121_0_22, (int) ('u'), G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 1, 1, 1, 1, 0, "u 'IngridHitSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
